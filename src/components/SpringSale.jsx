...
const springSaleData = [
  {
    ...
    title:
      "LP78245 Smart TV OLED 43 Inch 4K HD Dynamic Color Enhancer USB  ...",
    rating: 1,
    totalRating: 50,
    price: 310,
    bg: "white",
  ...
  },
  {
    ...
    categories: "CAMERA",
    title:
      "VBI Mini 2 Fly More Combo Drone Sjrc F22S 4K Pro Ptz 5 Km Version  ...",
    rating: 2,
    totalRating: 100,
    price: 320,
    bg: "white",
      ...
      <div className={`bg-[#F4F4F4] mt-20 py-16`}>
        <Container>
          <div className="flex justify-start items-center gap-x-[127px] relative">
            ...
            >
              <h2
                className={`font-["Poppins"] font-bold text-[56px] text-[#303030]`}
              >
                Spring Sale
              </h2>
              <div
              ...
              >
                <p className="flex flex-col items-center">
                  ...
                  <span
                    className={`font-["Montserrat"] font-normal text-base text-[#303030]`}
                  >
                    Days
                  </span>
                </p>
